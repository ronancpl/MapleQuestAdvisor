...
local function make_tab_resources_items(pRscProp)
    ...
    for iId, iCount in pairs(pRscProp:get_info_item():get_items()) do
        ...
        pVwItem:load(siType, iId, tpRscGridMini, pImg, pVwItem:get_visible_count(iId, iCount), sDesc, trgiFieldsRef, RResourceTable.VW_BASE.ITEMS, RResourceTable.VW_GRID_MINI.ITEMS, true)
