...
require("ui.run.build.canvas.worldmap.component.link")
require("ui.run.build.canvas.worldmap.component.node")
...
require("ui.struct.canvas.worldmap.component.region")
