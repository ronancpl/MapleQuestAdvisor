...
require("ui.struct.canvas.worldmap.component.link.link")
require("ui.struct.canvas.worldmap.component.link.link_img")
require("ui.struct.canvas.worldmap.component.link.map_link")
