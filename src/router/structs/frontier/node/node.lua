...
local function fn_sort_attainable(fn_attainable, m_fn_diff, m_pQuestAcc, pPlayerState)
    return function(a, b)
        return fn_attainable(m_fn_diff, m_pQuestAcc)(a, pPlayerState) < fn_attainable(m_fn_diff, m_pQuestAcc)(b, pPlayerState)
    end
end
